goog.provide('convnetjs.LocalResponseNormalizationLayer');
...
goog.scope(function() {
   ...
   * @export
   */
  convnetjs.LocalResponseNormalizationLayer = function(opt) {
    opt = opt || {};
  ...
  goog.inherits(convnetjs.LocalResponseNormalizationLayer, convnetjs.Layer);
  var pro = convnetjs.LocalResponseNormalizationLayer.prototype;
